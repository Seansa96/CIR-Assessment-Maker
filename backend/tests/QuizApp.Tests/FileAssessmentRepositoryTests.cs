...
public sealed class FileAssessmentRepositoryTests
{
    ...
    [InlineData("chemistry-general-chemistry-i-capstone-concept-lesson-s2c")]
    [InlineData("chemistry-general-chemistry-i-capstone-glossary-s2c")]
    [InlineData("chemistry-general-chemistry-i-capstone-worked-examples-s2c")]
    [InlineData("chemistry-general-chemistry-i-capstone-recall-s2c")]
    [InlineData("chemistry-general-chemistry-i-capstone-practice-s2c")]
    [InlineData("chemistry-general-chemistry-i-capstone-test-s2c")]
    [InlineData("chemistry-units-dimensional-analysis-concept-lesson-s2c")]
    [InlineData("chemistry-measurements-sig-figs-recall-s2c")]
    [InlineData("chemistry-gas-stoichiometry-test-s2c")]
    [InlineData("chem-functional-group-introduction-concept-lesson")]
    [InlineData("chem-functional-group-introduction-glossary")]
    [InlineData("chem-functional-group-introduction-guided-worked-examples")]
    [InlineData("chem-functional-group-introduction-mixed-recall")]
    [InlineData("chem-functional-group-introduction-focused-practice")]
    [InlineData("chem-functional-group-introduction-mastery-check")]
    [InlineData("chemistry-thermochemistry-hess-formation-worked-examples-s2c")]
    [InlineData("chemistry-measurements-glossary-s2c")]
    [InlineData("chemistry-measurements-test-s2c")]
    [InlineData("chemistry-units-glossary-s2c")]
    [InlineData("chemistry-units-recall-s2c")]
    [InlineData("chemistry-units-practice-s2c")]
    [InlineData("chemistry-units-test-s2c")]
    [InlineData("chemistry-gas-stoichiometry-glossary-s2c")]
    [InlineData("chemistry-thermochemistry-glossary-s2c")]
    [InlineData("chemistry-thermochemistry-recall-s2c")]
    [InlineData("chemistry-thermochemistry-formal-test-s2c")]
    ...
    [InlineData("calc2-parametric-curves-concept-lesson-s2c")]
    [InlineData("calc2-parametric-curves-glossary-s2c")]
    [InlineData("calc2-parametric-curves-recall-s2c")]
    [InlineData("calc2-parametric-curves-easy-quiz-s2c")]
    [InlineData("calc2-parametric-curves-hard-quiz-s2c")]
    [InlineData("calc2-parametric-derivatives-concept-lesson-s2c")]
    [InlineData("calc2-parametric-derivatives-glossary-s2c")]
    [InlineData("calc2-parametric-derivatives-recall-s2c")]
    [InlineData("calc2-parametric-derivatives-easy-quiz-s2c")]
    [InlineData("calc2-parametric-derivatives-hard-quiz-s2c")]
    [InlineData("calc2-parametric-integrals-concept-lesson-s2c")]
    [InlineData("calc2-parametric-integrals-glossary-s2c")]
    [InlineData("calc2-parametric-integrals-recall-s2c")]
    [InlineData("calc2-parametric-integrals-arc-length-worked-example-s2c")]
    [InlineData("calc2-parametric-integrals-easy-quiz-s2c")]
    [InlineData("calc2-parametric-integrals-hard-quiz-s2c")]
    [InlineData("calc2-polar-curves-concept-lesson-s2c")]
    [InlineData("calc2-polar-curves-glossary-s2c")]
    [InlineData("calc2-polar-curves-recall-s2c")]
    [InlineData("calc2-polar-curves-easy-quiz-s2c")]
    [InlineData("calc2-polar-curves-hard-quiz-s2c")]
    [InlineData("calc2-polar-calculus-concept-lesson-s2c")]
    [InlineData("calc2-polar-calculus-glossary-s2c")]
    [InlineData("calc2-polar-calculus-recall-s2c")]
    [InlineData("calc2-polar-calculus-arc-length-worked-example-s2c")]
    [InlineData("calc2-polar-calculus-easy-quiz-s2c")]
    [InlineData("calc2-polar-calculus-hard-quiz-s2c")]
    [InlineData("calc2-polar-graph-recognition-easy-quiz")]
    [InlineData("calc2-polar-graph-recognition-hard-quiz")]
    [InlineData("calc2-polar-calculus-area-worked-examples-s2c")]
    [InlineData("calc2-polar-curves-worked-examples-s2c")]
    ...
    [InlineData("calc2-power-series-worked-examples")]
    [InlineData("calc2-power-series-factorial-regrouping-worked-example")]
    [InlineData("calc2-taylor-maclaurin-coefficient-coordinates-concept-lesson")]
    [InlineData("calc2-taylor-notes-foundations-worked-example")]
    [InlineData("calc2-taylor-notes-construction-worked-example")]
    [InlineData("calc2-taylor-notes-error-worked-example")]
    [InlineData("calc2-taylor-notes-applications-worked-example")]
    [InlineData("calc2-finals-practice-easy-test")]
    [InlineData("calc2-finals-practice-hard-test")]
    [InlineData("calc2-finals-practice-olympiad-test")]
    [InlineData("calc2-infinite-series-unit4-test-simulation")]
    [InlineData("calc2-series-approximation-error-hard-quiz")]
    [InlineData("calc2-series-approximation-error-easy-test")]
    [InlineData("calc2-series-approximation-error-hard-test")]
    [InlineData("calc2-series-approximation-error-olympiad-test")]
    [InlineData("calc2-taylor-maclaurin-quick-paths-worked-example")]
    [InlineData("calc2-power-series-family-tree-concept-lesson")]
    [InlineData("calc2-power-series-family-tree-glossary")]
    [InlineData("calc2-power-series-family-tree-worked-example")]
    ...
    [InlineData("calc2-geometric-intuition-concept-lesson-s2c")]
    [InlineData("calc2-geometric-intuition-glossary-s2c")]
    [InlineData("calc2-geometric-intuition-recall-s2c")]
    [InlineData("calc2-geometric-intuition-worked-examples-s2c")]
    [InlineData("calc2-geometric-intuition-easy-quiz-s2c")]
    [InlineData("calc2-geometric-intuition-hard-quiz-s2c")]
    [InlineData("calc2-area-between-curves-concept-lesson-s2c")]
    [InlineData("calc2-area-between-curves-glossary-s2c")]
    [InlineData("calc2-area-between-curves-recall-s2c")]
    [InlineData("calc2-area-between-curves-worked-examples-s2c")]
    [InlineData("calc2-volumes-of-solids-concept-lesson-s2c")]
    [InlineData("calc2-volumes-of-solids-glossary-s2c")]
    [InlineData("calc2-volumes-of-solids-recall-s2c")]
    [InlineData("calc2-volumes-of-solids-worked-examples-s2c")]
    [InlineData("calc2-cylindrical-shells-concept-lesson-s2c")]
    [InlineData("calc2-cylindrical-shells-glossary-s2c")]
    [InlineData("calc2-cylindrical-shells-recall-s2c")]
    [InlineData("calc2-cylindrical-shells-worked-examples-s2c")]
    [InlineData("calc2-volumes-of-solids-easy-quiz-s2c")]
    [InlineData("calc2-volumes-of-solids-hard-quiz-s2c")]
    [InlineData("calc2-arc-length-surface-area-concept-lesson-s2c")]
    [InlineData("calc2-arc-length-surface-area-glossary-s2c")]
    [InlineData("calc2-arc-length-surface-area-recall-s2c")]
    [InlineData("calc2-arc-length-surface-area-worked-examples-s2c")]
    [InlineData("calc2-arc-length-surface-area-easy-quiz-s2c")]
    [InlineData("calc2-arc-length-surface-area-hard-quiz-s2c")]
    [InlineData("calc2-volume-methods-review-easy-test-s2c")]
    [InlineData("calc2-volume-methods-review-hard-test-s2c")]
    [InlineData("calc2-geometric-applications-review-easy-test-s2c")]
    [InlineData("calc2-geometric-applications-review-hard-test-s2c")]
    [InlineData("calc2-parametric-review-easy-test-s2c")]
    [InlineData("calc2-parametric-review-hard-test-s2c")]
    [InlineData("calc2-polar-curves-review-easy-test-s2c")]
    [InlineData("calc2-polar-curves-review-hard-test-s2c")]
    [InlineData("calc2-area-between-curves-easy-quiz-s2c")]
    ...
    public async Task Repository_loads_and_validates_mathematical_literacy_college_bridge_expansion()
    {
        ...
        Assert.DoesNotContain("mathematical-literacy-logic-recall-advanced", assessmentIds);
