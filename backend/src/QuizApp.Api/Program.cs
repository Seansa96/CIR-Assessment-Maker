...
var managedCodeRunnerOptions = builder.Configuration.GetSection(ManagedCodeRunnerOptions.SectionName).Get<ManagedCodeRunnerOptions>() ?? new ManagedCodeRunnerOptions();
builder.Services.AddSingleton(managedCodeRunnerOptions);
builder.Services.AddSingleton<ICodeRunnerDockerClient, CodeRunnerDockerClient>();
