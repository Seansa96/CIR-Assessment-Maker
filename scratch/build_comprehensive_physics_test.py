...
TEST=os.path.join(OUT,'Physics 2 Comprehensive Mixed Test.pdf'); KEY=os.path.join(OUT,'Physics 2 Comprehensive Mixed Test - Detailed Answer Key.pdf')
...
def draw_test():
    total=11; c=canvas.Canvas(TEST,pagesize=letter); c.setTitle('Physics 2 Comprehensive Mixed Test')
...
def draw_key():
    total=11; c=canvas.Canvas(KEY,pagesize=letter); c.setTitle('Physics 2 Comprehensive Mixed Test - Detailed Answer Key')
