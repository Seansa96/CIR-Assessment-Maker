# AoPS Volume 1 Reference Index

Local source: *The Art of Problem Solving, Volume 1: The Basics* (user-provided PDF).

Files are original paraphrases and original question banks. Do not copy source exercises, solutions, or extended passages.

## Batch 1
- Chapter 1: [Exponents and Logarithms](chapter-01-exponents-and-logarithms.md) -> `aops-exponents-logarithms` (pdf 15-26; printed 1-12)
- Chapter 2: [Complex Numbers](chapter-02-complex-numbers.md) -> `aops-complex-numbers` (pdf 27-30; printed 13-16)
- Chapter 3: [Linear Equations](chapter-03-linear-equations.md) -> `aops-linear-equations` (pdf 31-41; printed 17-27)
- Chapter 4: [Proportions](chapter-04-proportions.md) -> `aops-proportions` (pdf 42-52; printed 28-38)

## Batch 2
- Chapter 5: [Using the Integers](chapter-05-using-the-integers.md), [bank](chapter-05-using-the-integers-question-bank.yaml) -> `aops-integers-number-theory` (pdf 53-65; printed 39-51)
