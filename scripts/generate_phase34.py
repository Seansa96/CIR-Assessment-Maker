...
def main():
    # Phase 3
    gen_ch(9, "ec-ac-analysis", "Sinusoidal Steady-State Analysis", "Solve phasor circuit.", "Use V = IZ.")
    gen_ch(10, "ec-ac-power", "Sinusoidal Steady-State Power", "Calculate complex power.", "S = V I*.")
    gen_ch(11, "ec-three-phase", "Balanced Three-Phase Circuits", "Analyze Y-Y circuit.", "Use per-phase equivalent.")
    gen_ch(12, "ec-laplace-intro", "Intro to Laplace Transform", "Find Laplace transform.", "Use integral definition.")
    gen_ch(13, "ec-laplace-analysis", "Laplace Transform in Circuits", "Solve with s-domain.", "Use 1/sC and sL.")
    gen_ch(14, "ec-frequency-selective", "Frequency Selective Circuits", "Design low-pass filter.", "Use RC circuit.")
    
    # Phase 4
    gen_ch(15, "ec-active-filters", "Active Filter Circuits", "Analyze active filter.", "Use op-amp rules.")
    gen_ch(16, "ec-fourier-series", "Fourier Series", "Find Fourier series.", "Calculate coefficients.")
    gen_ch(17, "ec-fourier-transform", "The Fourier Transform", "Find Fourier transform.", "Use integral.")
    gen_ch(18, "ec-two-port", "Two-Port Circuits", "Find z parameters.", "Open circuit tests.")
